    ...
    <div className="min-h-screen bg-[#ffffff]">
      <div className="max-w-undifest mx-auto pb-20">
        ...
        <div className="px-4 py-8 bg-[#16202a]">
          <h1 className="text-3xl font-bold text-white mb-6">FAQ – Undifest</h1>

          <div className="space-y-8 text-white">
            <section>
              <h3 className="text-xl font-bold mb-3">Apa itu Undifest?</h3>
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Apa produk utama yang dijual di Undifest?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Apa yang saya dapatkan setelah membeli e-book?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Apakah pembelian e-book tetap sah tanpa mengikuti program hadiah?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Bagaimana mekanisme program apresiasi hadiah?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Kapan informasi penerima hadiah diumumkan?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Jika saya tidak mendapatkan hadiah, apakah dana saya dikembalikan?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Kapan proses pengembalian dana dilakukan?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Ke mana dana pengembalian dikirim?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Apakah ada biaya atau potongan dalam proses pengembalian dana?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Bagaimana Undifest menjaga transparansi kepada pembeli?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Apakah data pribadi saya aman?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Apakah Undifest menjanjikan hadiah tertentu?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3">Di mana saya bisa membaca ketentuan lengkap?</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
