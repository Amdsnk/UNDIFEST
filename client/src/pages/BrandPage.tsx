    ...
    <div className="min-h-screen bg-[#0a1621]">
      <div className="pb-20">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-white mb-2">Identitas Brand</h1>
          <p className="text-gray-400 mb-8">
            Mengenal lebih dekat identitas dan nilai-nilai Undifest
          </p>
          
          <div className="space-y-6 text-white">
            <section>
              <h3 className="text-xl font-bold mb-3 text-[#00D4FF]">Tentang Undifest</h3>
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-[#00D4FF]">Nilai-Nilai Kami</h3>
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">🛡️ Keamanan</h4>
                  <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">⚖️ Keadilan</h4>
                  <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-[#00D4FF]">Identitas Visual</h3>
              <div className="space-y-4">
                <div>
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-[#00D4FF]">Tagline</h3>
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-[#00D4FF]">Legalitas dan Pengawasan</h3>
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
