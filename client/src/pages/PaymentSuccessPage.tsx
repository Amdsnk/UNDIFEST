            ...
            <>
              ...
              <div className="w-full max-w-md mt-6 text-center">
                <p className="text-gray-300 text-sm mb-5 leading-relaxed">
                  Silakan hubungi WhatsApp kami untuk mengetahui hasil undian dan informasi kemenangan.
                </p>
                <a
                  href="https://wa.me/628811111898"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-1 group"
                >
                  <div className="w-20 h-20 bg-[#25D366] rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
                  ...
                  <p className="text-gray-300 text-sm font-semibold mt-2 tracking-widest">CHAT WHATSAPP</p>
                  <p className="text-white text-lg font-bold tracking-wider">08811111898</p>
                </a>
              </div>
            </>
          )}
